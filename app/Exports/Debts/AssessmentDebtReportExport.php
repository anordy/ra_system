...
class AssessmentDebtReportExport implements FromView, WithEvents, ShouldAutoSize
{
    ...
    public function view(): View
    {
        ...
        return view('exports.debts.excel.assessment', compact('records', 'title', 'parameters'));
    }
}
