...
class InstallmentReportExport implements FromView, WithEvents, ShouldAutoSize
{
    ...
    public function view(): View
    {
        ...
        return view('exports.debts.excel.installment', compact('records', 'title', 'parameters'));
    }
}
