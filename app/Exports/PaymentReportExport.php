...
class PaymentReportExport implements FromView, WithEvents, ShouldAutoSize
{
    ...
    public function view(): View
    {
        ...
        {
            return view('exports.payments.reports.excel.return', compact('records', 'title', 'parameters'));
        }
        else{
            return view('exports.payments.reports.excel.consultant', compact('records', 'title', 'parameters'));
        }
    }
}
