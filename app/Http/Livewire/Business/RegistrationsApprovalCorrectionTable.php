...
class RegistrationsApprovalCorrectionTable extends DataTableComponent
{
    ...
    public function builder(): Builder
    {
        ...
        if ($this->correction) {
            return Business::with('category')->where('businesses.status', BusinessStatus::CORRECTION)->orderBy('businesses.created_at', 'desc');
        }
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Action', 'id')
                ->view('business.registrations.includes.approval_correction')
        ];
    }
}
