...
class CasesTable extends DataTableComponent
{
    ...
    {
        return [
            Column::make("Case #", "case_number")
                ->sortable(),
            Column::make("Business Name", "tax_investigation.business.name")
                ->sortable(),
            Column::make("Date Opened", "date_opened")
                ->sortable(),
            Column::make("Case Stage", "case_stage.name")
                ->sortable(),
            Column::make("Case Outcome", "case_outcome.name")
                ->sortable(),
