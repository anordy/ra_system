                ...
                ->format(
                    function ($value) {
                        ...
                        if (Gate::allows('setting-exchange-rate-edit') && approvalLevel(Auth::user()->level_id, 'Maker')) {
                            $edit = <<< HTML
                                <button class="btn btn-info btn-sm" id="showDataTableModal" data-modal-name="exchange-rate-edit-modal" data-modal-value="$value"><i class="bi bi-pencil-square"></i> </button>
                            HTML;
                        }
