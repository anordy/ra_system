...
class ReorderFeesTable extends DataTableComponent
{
    use CustomAlert;

    protected $model = MvrReorderPlateNumberFee::class;
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Gfs Code', 'gfs_code')
                ->sortable()
                ->searchable(),
                Column::make('RFID', 'is_rfid')
                ->sortable()
                ->searchable()
                ->format(fn ($value) => $value ? 'Yes' : 'No'),
            Column::make('Plate Sticker', 'is_plate_sticker')
                ->sortable()
                ->searchable()
                ->format(fn ($value) => $value ? 'Yes' : 'No'),
