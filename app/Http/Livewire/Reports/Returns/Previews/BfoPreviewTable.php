...
class BfoPreviewTable extends DataTableComponent
{
    ...
    {
        $mnos = $this->getRecords(BfoReturn::query(), $this->parameters);
        return $mnos;
    }
    ...
    public function configure(): void
    {
        ...
        $this->setAdditionalSelects(['bfo_returns.business_id', 'bfo_returns.business_location_id', 'bfo_returns.financial_month_id', 'bfo_returns.financial_year_id', 'bfo_returns.created_at', 'bfo_returns.filed_by_id', 'bfo_returns.filed_by_type']);
    }
