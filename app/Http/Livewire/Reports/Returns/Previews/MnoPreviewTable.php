...
class MnoPreviewTable extends DataTableComponent
{
    ...
    {
        $mnos = $this->getRecords(MnoReturn::query(), $this->parameters);
        return $mnos;
    }
    ...
    public function configure(): void
    {
        ...
        $this->setAdditionalSelects(['mno_returns.business_id', 'mno_returns.business_location_id', 'mno_returns.financial_month_id', 'mno_returns.financial_year_id', 'mno_returns.created_at', 'mno_returns.filed_by_id', 'mno_returns.filed_by_type']);
    }
