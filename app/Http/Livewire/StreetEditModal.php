...
class StreetEditModal extends Component
{
    ...
    public function submit()
    {
        ...
        try {
            ...
            $this->triggerDualControl(get_class($this->street), $this->street->id, DualControl::EDIT, 'editing street '.$this->name, json_encode($this->old_values), json_encode($payload));
            DB::commit();
