...
class VerificationSendNotificationLetterToTaxPayer extends Mailable
{
    use Queueable, SerializesModels;

    public $payload, $taxpayer, $return;
    /**
    ...
    public function build()
    {
        ...
        $email = $this->markdown('emails.verification.notification-letter-to-taxpayer')->subject('Notification of Tax Verification');
