...
trait TaxClaimsTrait
{
    ...
    public function triggerClaim(int $amount, string $currency, $oldReturn, $newReturn = null)
    {
        try {
            ...
            Log::error('TRAITS-TAX-CLAIM-TRAIT-TRIGGER-CLAIM', [$exception]);
            throw $exception;
        }
    }
     ...
     */
    public
    function getUsableCredit($creditable, $currency): array
    {
        try {
            ...
            if ($credit->payment_method == PaymentMethod::FULL) {
                return [
            ...
            if ($credit->payment_method == PaymentMethod::INSTALLMENT) {
            ...
            Log::error('TRAITS-TAX-CLAIM-TRAIT-GET-USABLE-CREDIT', [$exception]);
            throw $exception;
        }
    }
    ...
    public function useCredit($creditable, $return, $maxAmount, $currency)
    {
        try {
            ...
            Log::error('TRAITS-TAX-CLAIM-TRAIT-USE-CREDIT', [$exception]);
            throw $exception;
        }
    }
}