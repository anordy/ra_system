...
class CreateVatReturnConfigsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vat_return_configs', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('col_type',['total', 'subtotal','normal', 'external'])->default('normal');
    ...
    {
        Schema::dropIfExists('vat_return_configs');
    }
}
