...
class CreateEmTransactionConfigsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('em_transaction_configs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('em_transaction_configs');
    }
}
