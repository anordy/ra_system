...
class CreateMMTransferConfigsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mm_transfer_configs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('m_m_transfer_configs');
    }
}
