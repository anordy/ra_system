...
class CreateMmTransferPenaltiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mm_transfer_penalties', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('mm_transfer_penalties');
    }
}
