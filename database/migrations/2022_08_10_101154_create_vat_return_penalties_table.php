...
class CreateVatReturnPenaltiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vat_return_penalties', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('vat_return_penalty');
    }
}
