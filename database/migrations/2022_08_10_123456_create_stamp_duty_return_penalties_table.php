...
class CreateStampDutyReturnPenaltiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('stamp_duty_return_penalties', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('stamp_duty_return_penalties');
    }
}
