...
class CreateCharteredReturnConfigsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('chartered_return_configs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('chartered_return_configs');
    }
}
