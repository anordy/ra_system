...
class CreateNtrElectronicVatReturnPenaltiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ntr_electronic_vat_return_penalties', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ntr_electronic_vat_return_penalties');
    }
}
