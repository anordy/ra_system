...
class TaxTypesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        TaxType::updateOrCreate(['gfs_code' => '116101', 'name' => 'Penalties', 'code' => TaxType::PENALTY]);
        TaxType::updateOrCreate(['gfs_code' => '116101', 'name' => 'Interests', 'code' => TaxType::INTEREST]);
        TaxType::updateOrCreate(['gfs_code' => '116101', 'name' => 'Infrastructure', 'code' => TaxType::INFRASTRUCTURE]);
