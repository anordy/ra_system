...
class WorkflowMvrRegistrationStatusChangeSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $name = 'mvr_registration_status_change';
        $type = 'workflow';
        $marking_store = [
            'type'      => 'multiple_state',
            'property'  => ['marking']
        ...
        $supports =  ['App\Models\MvrRegistrationStatusChange'];
        $places = [
            'apply' => [
                'owner' => 'taxpayer',
                'operator_type' => 'user',
        ...
        Workflow::updateOrCreate(
            [
                'code' => 'MVR_REGISTRATION_STATUS_CHANGE'
            ],
            [
            'code' => 'MVR_REGISTRATION_STATUS_CHANGE',
            'summary' => 'Motor Vehicle Registration Status Change',
            'name' => $name,
            'type' => $type,
