...
class WorkflowMvrTemporaryTransportSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $supports =  ['App\Models\MvrTemporaryTransport'];
        $places = [
            'apply' => [
                'owner' => 'taxpayer',
                'operator_type' => 'user',
        ...
        Workflow::updateOrCreate(
            [
                'code' => 'MVR_TEMPORARY_TRANSPORT',
            ],
            [
            'code' => 'MVR_TEMPORARY_TRANSPORT',
            'summary' => 'Motor Vehicle Temporary Transportation',
            'name' => $name,
            'type' => $type,
