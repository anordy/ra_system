...
class WorkflowPublicServiceDeRegistrationSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $name = 'public_service_de_registration';
        $type = 'workflow';
        $marking_store = [
            'type'      => 'multiple_state',
            'property'  => ['marking']
        ...
        $supports =  ['App\Models\PublicService\DeRegistration'];
        $places = [
            'apply' => [
                'owner' => 'taxpayer',
                'operator_type' => 'user',
        ...
        Workflow::updateOrCreate(
            [
                'code' => 'PUBLIC_SERVICE_DE_REGISTRATION'
            ],
            [
                'code' => 'PUBLIC_SERVICE_DE_REGISTRATION',
