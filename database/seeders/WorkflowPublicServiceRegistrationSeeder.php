...
class WorkflowPublicServiceRegistrationSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $name = 'public_service_registration';
        $type = 'workflow';
        $marking_store = [
            'type'      => 'multiple_state',
            'property'  => ['marking']
        ...
        $supports =  ['App\Models\PublicService\PublicServiceMotor'];
        $places = [
            'apply' => [
                'owner' => 'taxpayer',
                'operator_type' => 'user',
        ...
        Workflow::updateOrCreate(
            [
                'code' => 'PUBLIC_SERVICE_REGISTRATION'
            ],
            [
            'code' => 'PUBLIC_SERVICE_REGISTRATION',
            'summary' => 'Public Service Registration',
            'name' => $name,
            'type' => $type,
