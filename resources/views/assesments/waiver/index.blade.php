...
@section('content')
    <div class="card p-0 m-0">
        ...
        {{-- <div class="card-body mt-0 p-2">
                @livewire('approval.approval-count-card', ['modelName' => 'Dispute'])
            <nav class="nav nav-tabs mt-0 border-top-0 mb-3">
                ...
                <a href="#pending-approval" class="nav-item nav-link font-weight-bold">Pending Waivers</a>
            ...
            <div class="tab-content px-2 pt-3 pb-2 border border-top-0">
                ...
                <div id="pending-approval" class="tab-pane fade">
                    @livewire('assesments.waiver.waiver-table', ['category' => 'waiver', 'status' => 'pending'])
                </div>
                 <div id="progress-approval" class="tab-pane fade">
                    @livewire('assesments.waiver.waiver-approval-progress-table')
                </div>
