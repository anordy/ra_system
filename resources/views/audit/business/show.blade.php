            ...
            <div class="card-header text-uppercase font-weight-bold bg-white">
                ...
                <div class="container">
                    <div class="card-tools">
                        <button class="btn btn-info btn-sm" onclick="Livewire.emit('showModal', 'audit.business-audit-add-modal', {{ json_encode(['business_id' => $location->business->id, 'location_ids' => $location->id]) }})">
                                    ...
                                    <div class="card-body">
                                        @switch(true)
                                            ...
                                            @case($taxReturn instanceof \App\Models\Returns\MmTransfer\MmTransferReturn)
                                                @include(
                                                    'returns.excise-duty.mobile-money-transfer.details',
                                                    ['return' => $taxReturn]
                                                )
                                            @break
