@if($row->pinstance->status === \App\Models\BusinessStatus::APPROVED)
    <span class="badge badge-success py-1 px-2"  style="border-radius: 1rem; background: #72DC3559; color: #319e0a; font-size: 85%">
        <i class="bi bi-check-circle-fill mr-1"></i>
        Approved
    </span>
@elseif($row->pinstance->status === \App\Models\BusinessStatus::PENDING)
...
@elseif($row->pinstance->status === \App\Models\BusinessStatus::DRAFT)
...
@elseif($row->pinstance->status === \App\Models\BusinessStatus::CORRECTION)
...
@elseif($row->pinstance->status === \App\Models\BusinessStatus::TEMP_CLOSED)
    <span class="badge badge-danger py-1 px-2" style="border-radius: 1rem; background: rgba(220,53,53,0.35); color: #cf1c1c; font-size: 85%">
        <i class="bi bi-record-circle mr-1"></i>
        Closed
    </span>
@elseif($row->pinstance->status === \App\Models\BusinessStatus::DEREGISTERED)
    <span class="badge badge-danger py-1 px-2" style="border-radius: 1rem; background: rgba(220,53,53,0.35); color: #cf1c1c; font-size: 85%">
        <i class="bi bi-record-circle mr-1"></i>
        Deregistered
    </span>
