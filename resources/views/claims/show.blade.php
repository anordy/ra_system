                ...
                <div class="col-md-12 mt-3">
                    <ul class="nav nav-tabs shadow-sm" id="myTab" role="tablist" style="margin-bottom: 0;">
                        ...
                        @if(count($claim->credit->items))
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="credit-items-tab" data-toggle="tab" href="#credit-items" role="tab" aria-controls="credit-items" aria-selected="false">Credit Items</a>
                            </li>
                        @endif
                    </ul>
                    <div class="tab-content bg-white border shadow-sm" id="myTabContent" style="padding: 1rem !important;">
                        ...
                        @endif
                        @if(count($claim->credit->items))
                            <div class="tab-pane fade" id="credit-items" role="tabpanel" aria-labelledby="credit-items-tab">
