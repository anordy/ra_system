@if ($tax_return->debtWaiver)
    ...
    <div class="row m-2 pt-3">
        <div class="col-md-4 mb-3">
            ...
            <p class="my-1">{{ $tax_return->debtWaiver->category }}</p>
        </div>
        <div class="col-md-4 mb-3">
            <span class="font-weight-bold text-uppercase">Waiver Status</span>
            <p class="my-1"><span class="badge badge-info">{{ $tax_return->debtWaiver->status }}</span></p>
        </div>
        <div class="col-md-4 mb-3">
        ...
        <div class="col-md-4 mb-3">
            ...
            <p class="my-1">{{ number_format($tax_return->debtWaiver->penalty_rate, 2)  }} % of {{ number_format($tax_return->return->penalty, 2) }}
            </p>
        </div>
        <div class="col-md-4 mb-3">
            <span class="font-weight-bold text-uppercase">Waived Interest Percentage</span>
            <p class="my-1"> {{ number_format($tax_return->debtWaiver->interest_rate, 2)  }} % of {{ number_format($tax_return->interest, 2) }}
            </p>
        </div>
