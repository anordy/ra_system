...
<head>
    ...
    <div id="owner-name">{{strtoupper($license->drivers_license_owner->taxpayer->fullname())}}</div>
    <div id="sex">{{strtoupper($license->drivers_license_owner->taxpayer->sex ??'Male')}}</div>
    ...
    <div id="blood-group">{{($license->drivers_license_owner->blood_group->name)}}</div>
    <div id="class">
    ...
    <div id="zin">{{($license->drivers_license_owner->taxpayer->reference_no)}}</div>
