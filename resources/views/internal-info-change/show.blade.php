    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active card p-2" id="profile" role="tabpanel" aria-labelledby="profile-tab">
            ...
            <div class="card-body">
                ...
                <livewire:approval.internal-business-info-change-processing modelName="{{ get_class($info) }}"
                                                                            modelId="{{ encrypt($info->id) }}"></livewire:approval.internal-business-info-change-processing>
