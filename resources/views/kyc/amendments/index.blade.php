...
@section('title')
    Kyc Details Amendment Requests
@endsection
        ...
        <div class="card-body mt-0 p-2">
            ...
            <div class="tab-content px-2 card pt-3 pb-2">
                <div id="tab1" class="tab-pane fade active show m-2">
                    <livewire:kyc.kyc-amendment-request-table status='pending'></livewire:kyc.kyc-amendment-request-table>
                </div>
                <div id="tab2" class="tab-pane fade m-2">
                    <livewire:kyc.kyc-amendment-request-table status='approved'></livewire:kyc.kyc-amendment-request-table>
                </div>
                <div id="tab3" class="tab-pane fade m-2">
                    <livewire:kyc.kyc-amendment-request-table status='rejected'></livewire:kyc.kyc-amendment-request-table>
                </div>
                <div id="tab4" class="tab-pane fade m-2">
                    <livewire:kyc.kyc-amendment-request-table status='tempered'></livewire:kyc.kyc-amendment-request-table>
                </div>
            </div>
        </div>
    </div>
