                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-6">
                        <div class="form-group">
                            ...
                            <input disabled class="form-control" value="{{ \Carbon\Carbon::make($subject->extensible->curr_payment_due_date)->toFormattedDateString() }}" />
                        </div>
                    </div>
                    <div class="form-group col-lg-6">
                        <div class="form-group">
                            <label>Extend to</label>
                            <input min="{{ \Carbon\Carbon::make($subject->extensible->curr_payment_due_date)->toDateString() }}"
                                   max="{{ \Carbon\Carbon::make($subject->extensible->curr_payment_due_date)->addYear()->toDateString() }}"
