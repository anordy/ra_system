            ...
            @if($this->checkTransition('mvr_zartsa_review'))
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" wire:model.defer="bodyStyle">
                        @error('bodyStyle')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" wire:model.defer="engineNo">
                        @error('engineNo')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-lg-4">
                        ...
                        <input type="text" class="form-control" wire:model.defer="chassisNo">
                        @error('chassisNo')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
