    ...
    <div class="card shadow-sm mb-2 bg-white">
        ...
        <div class="card-body">
            ...
            @if ($this->checkTransition('mvr_zartsa_review'))
                @include('livewire.approval.mvr.transfer.zartsa_review')
            @endif

            @if ($this->checkTransition('zbs_officer_review'))
                @include('livewire.approval.mvr.transfer.zbs_review')
            @endif

            @if ($this->checkTransition('bpra_officer_review'))
                @include('livewire.approval.mvr.transfer.bpra_review')
            @endif
