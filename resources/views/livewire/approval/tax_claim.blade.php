    ...
    <div class="card shadow-sm mb-2 bg-white rounded-0">
        ...
        <div class="card-body p-4">
            ...
            @if ($this->checkTransition('verification_results'))
                <div class="row">
                    <div class="form-group col-lg-12">
                        <label class="control-label font-weight-bold text-uppercase">Tax Claim Verification
                            Assessment</label>
                    </div>
                    <div class="form-group col-lg-6">
                        <label class="control-label">Assessment Report</label>
                        <input type="file"
                               class="form-control-file border p-1  @error('assessmentReport') is-invalid @enderror"
                    ...
                    <div class="col-md-12 mb-3">
                        <livewire:claims.set-figure.set-figure-component :taxClaimId="$subject->id"/>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    @if($paymentType === 'installment')
                        <div class="col-md-4 form-group">
                            ...
                            <input class="form-control @error('installmentCount') is-invalid @enderror"
                                   wire:model="installmentCount" placeholder="E.g. 2 phases" max="12" type="number">
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="form-control" disabled
                                   value="{{ number_format($this->calcMoney(), 2) }} {{ $this->subject->currency }}">
                        </div>
                    @endif
                </div>
            @endif
        ...
        @elseif ($this->checkTransition('assign_officers'))
            <div class="modal-footer p-2 m-0">
                <button type="button" class="btn btn-primary"
                        wire:click="confirmPopUpModal('approve', 'assign_officers')">Assign &
                    Forward
                </button>
            </div>
        @elseif ($this->checkTransition('verification_results'))
            <div class="modal-footer p-2 m-0">
                <button type="button" class="btn btn-primary"
                        wire:click="confirmPopUpModal('approve', 'verification_results')">
                    Approve & Continue
                </button>
            </div>
        @elseif ($this->checkTransition('method_of_payment'))
            <div class="modal-footer p-2 m-0">
                <button type="button" class="btn btn-primary"
                        wire:click="confirmPopUpModal('approve', 'method_of_payment')">
                    Approve & Continue
                </button>
            </div>
        ...
        @elseif ($this->checkTransition('correct_reviewed_report'))
            <div class="modal-footer p-2 m-0">
                <button type="button" class="btn btn-danger"
                        wire:click="confirmPopUpModal('reject', 'correct_reviewed_report')">
                    Reject & Return Back
                </button>
                <button type="button" class="btn btn-primary" wire:click="confirmPopUpModal('approve', 'accepted')">
                    Approve & Complete
