    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-uppercase">Close Appeal</h5>
            ...
            <div class="model-body">
                <div class="row pr-3 pl-3">
                    <div class="form-group col-lg-12">
                        <label class="control-label">Date Concluded</label>
                ...
                <div class="row pr-3 pl-3">
                    <div class="form-group col-lg-12">
                        ...
                        <select wire:model="outcome_id" class="form-control" id="outcome_id">
                            <option>Choose option</option>
                            @foreach (\App\Models\CaseOutcome::all() as $option)
