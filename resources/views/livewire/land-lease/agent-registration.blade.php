<div>
    ...
    <div class="row m-2">
        <div class="col-md-12 form-group">
            <label for="zin">Taxpayer Ref. No.</label>
            <input type="text" wire:model.lazy="taxpayerRefNo"
            ...
            @if ($lookup_fired && !empty($taxpayer))
                    ...
                    <div class="card-body">
                        ...
                        <div class="row my-2">
                            <div class="col-md-4 mb-3">
                                ...
                                <p class="my-1">
                                    {{ "{$taxpayer->first_name} {$taxpayer->middle_name} {$taxpayer->last_name}" }}</p>
                            </div>
                            <div class="col-md-4 mb-3">
                ...
                <div class="row mt-3">
                    <div class="col-md-12 d-flex justify-content-center">
                        <a href="{{ route('land-lease.agents') }}" class="btn btn-danger mr-2">Cancel</a>
                        <button wire:click="submit" wire:loading.attr="disabled" class="btn btn-primary">
                            <div wire:loading wire:target="submit">
                                <div class="spinner-border mr-1 spinner-border-sm text-light" role="status">
                                    <span class="sr-only">Loading...</span>
                                </div>
                            </div>Register as Agent
                        </button>
                    </div>
                </div>
            @elseif($lookup_fired)
                <p class="my-1 text-danger"> The Taxpayer Reference Number  does not exist </p>
            @endif
        </div>
