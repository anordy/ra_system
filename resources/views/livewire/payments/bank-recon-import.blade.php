<div class="card rounded-0">
    <div class="card-header font-weight-bold text-uppercase bg-white">
        Import Bank Reconciliations {{ $path ?? 'Not Found.' }}
    </div>
    <div class="card-body px-4">
        ...
        <div class="row mx-0">
            <div class="form-group mb-0 flex-grow-1 mr-2">
                <input wire:model="reconFile" accept="text/csv" class="form-control form-control-file" type="file" placeholder="Choose file to import">
            </div>
