<div>
    @if ($return->tax_return && $return->tax_return->vetting_status == \App\Enum\VettingStatus::CORRECTION)
        <livewire:approval.approval-processing modelName="{{ \App\Models\Returns\TaxReturn::class }}"
                                               modelId="{{ $return->tax_return->id }}"/>
    @endif
        <div class="card">
                ...
                <div class="row border rounded mx-1 p-2 mb-3">
                    @if($taxType->code === \App\Models\TaxType::CHARTERED_SEA)
                        <div class="col-md-3 form-group">
                            <label class="font-weight-bold text-uppercase">Shipping line company name</label>
                            <input type="text" maxlength="40" wire:model="companyName"
