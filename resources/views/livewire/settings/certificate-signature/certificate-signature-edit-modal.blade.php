    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-uppercase">Edit Certificate</h5>
            ...
            <div class="modal-body">
                <div class="row pr-3 pl-3">
                    ...
                    <div class="form-group col-lg-12">
                        <label class="control-label">Signature Picture (Upload to Replace)</label>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <p class="my-1">
                            <img src="{{ $currentSignature }}" alt="Missing Signature">
                        </p>
                    </div>
