    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-uppercase">Edit Zrb Bank Account: {{$zrbBankAccount->account_number}}</h5>
                ...
                <div class="row pr-3 pl-3">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <select type="text" class="form-control" wire:model.defer="currency_id" id="currency_id">
                                ...
                                <option {{($currency->id == $zrbBankAccount->currency_id) ? 'selected' : ''}} value="{{ $currency->id }}">{{ $currency->iso }}</option>
                            @endforeach
                        </select>
                        @error('currency_id')
                            <span class="text-danger">{{ $message }}</span>
