<div>
{{--    {{ $taxagent->id }}--}}
{{--    <button class="btn btn-outline-success btn-sm" wire:click="approve()"><i class="fa fa-check"></i>Approve</button>--}}
{{--    <button class="btn btn-outline-danger btn-sm" wire:click="reject()"><i class="bi bi-x-circle-fill"></i> Reject</button>--}}
