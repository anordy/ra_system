    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title text-uppercase text-center">Adding rates configuration VAT return</h6>
                ...
                <div class="row pr-3 pl-3">
                    <div class="row">
                        <div class="form-group col-lg-6">
                            <label class="control-label">Vat Services</label>
                        ...
                        <div class="form-group col-lg-6">
                            <label class="control-label">Vat Category</label>
