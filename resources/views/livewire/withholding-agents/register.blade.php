        ...
        <div class="pt-1">
            <div class="border-0">
                ...
                <div class="row mx-4 mt-2">
                    ...
                    <div class="col-md-4 form-group">
                        <label for="mobile">Contact number of the Institution</label>
                    ...
                    <div class="col-md-4 form-group">
                        <label for="email">Email Address of the Institution</label>
            ...
            <div class="mt-4 border-0">
                ...
                <div class="row mx-4 mt-2">
                    ...
                    @if ($search_triggered && !empty($taxpayer))
                        <div class="col-8 p-3" style="border: 1px solid #ede6e6;">
                            <div class="row">
                                <div class="col-12">
                                    <br>
