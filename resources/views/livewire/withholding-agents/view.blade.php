            ...
            <div class="row mb-2">
                ...
                <div class="col-md-6 text-right">
                    <button class="btn btn-info"
                            onclick="Livewire.emit('showModal', 'withholding-agents.add-responsible-person-modal','{{ encrypt($withholding_agent->id) }}')">
                        Add Responsible Person
                    </button>
                </div>
            </div>
            <livewire:withholding-agents.withholding-agent-responsible-persons-table
                    :id="encrypt($withholding_agent->id)"></livewire:withholding-agents.withholding-agent-responsible-persons-table>
        </div>
    </div>
</div>
