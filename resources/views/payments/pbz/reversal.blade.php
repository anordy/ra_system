        ...
        <div class="card-body p-2">
            <div class="row ">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <p class="my-1 text-uppercase">{{ $reversal->control_number ?? 'N/A' }}</p>
                </div>
            </div>
        </div>
    </div>

    @if($bill = $reversal->bill)
        <div class="card rounded-0">
        ...
        @if($reversal->bill->bill_payments->count())
            <div class="card rounded-0">
                <div class="card-header bg-white font-weight-bold text-uppercase">
                    Payment Details
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 table-responsive ">
                            <table class="table table-sm  table-bordered ">
                                ...
                                <tbody>
                                @foreach ($reversal->bill->bill_payments as $payment)
                                    <tr>
