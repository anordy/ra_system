...
<head>
    ...
    <style>
        ...
        .tbl-stripped tbody tr:nth-child(even) {
...
<table style="border-collapse:collapse; width:100%">
    ...
    <tr>
        <th style="text-align:center;" colspan="15">
            <img style="height: 100px; width: auto;" src="{{ public_path() }}/images/logo-square.png" alt="ZRA Logo">
...
<br>
<table style="width: 100%;" class="tbl-bordered tbl-stripped tbl-p-6">
    <tbody>
    <tr>
        <td width="27%">
...
<table class="tbl-bordered tbl-stripped tbl-p-6" style="width: 100%; margin-top: 10px;">
    <thead>
    <tr>
        <th>Month</th>
        <th>Tax Amount</th>
