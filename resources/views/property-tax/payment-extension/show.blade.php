        ...
        <div class="card-body">
            <div class="row m-2 pt-3">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <p class="my-1">{{ $paymentExtension->propertyPayment->property->region_id ?? 'N/A' }}</p>
                </div>
                <div class="col-md-4 mb-3">
                    <span class="font-weight-bold text-uppercase">District</span>
                    <p class="my-1">{{ $paymentExtension->propertyPayment->property->district_id ?? 'N/A' }}</p>
                </div>
                <div class="col-md-4 mb-3">
                    <span class="font-weight-bold text-uppercase">Ward</span>
                    <p class="my-1">{{ $paymentExtension->propertyPayment->property->ward_id ?? 'N/A' }}</p>
                </div>
                <div class="col-md-4 mb-3">
                    <span class="font-weight-bold text-uppercase">Street</span>
                    <p class="my-1">{{ $paymentExtension->propertyPayment->property->street_id ?? 'N/A' }}</p>
                </div>
                <div class="col-md-4 mb-3">
