...
@section('title', __('Transport Service De-registrations Details'))
    ...
    <ul class="nav nav-tabs shadow-sm" id="myTab" role="tablist" style="margin-bottom: 0;">
        <li class="nav-item" role="presentation">
            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home"
               aria-selected="true"> Transport Service De-registration</a>
        </li>
        <li class="nav-item" role="presentation">
        ...
        <div class="tab-pane fade show active pt-3 px-3" id="home" role="tabpanel" aria-labelledby="home-tab">
            <div class="card shadow-none">
                <div class="card-header text-uppercase font-weight-bold bg-white">
                    {{ __('Transport Service De-registrations Details') }}
                </div>
                <div class="card-body">
                    <div class="row">
