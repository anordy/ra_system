@if($row->payment_status == \App\Enum\BillStatus::COMPLETE)
...
@elseif($row->payment_status == \App\Enum\BillStatus::SUBMITTED)
...
@elseif($row->payment_status == \App\Enum\BillStatus::CN_GENERATION_FAILED)
    <span class="badge badge-success py-1 px-2"  style="border-radius: 1rem; background: #72DC3559; color: #319e0a; font-size: 85%">
