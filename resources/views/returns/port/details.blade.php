                    ...
                    <tbody>
                        @if(count($return->penalties))
                            ...
                            <tr>
                                ...
                                <td>{{ number_format($penalty['tax_amount'], 2) }} <strong>{{ $penalty->currency}}</strong></td>
                                <td>{{ number_format($penalty['late_filing'], 2) }} <strong>{{ $penalty->currency}}</strong></td>
                                <td>{{ number_format($penalty['late_payment'], 2) }} <strong>{{ $penalty->currency}}</strong></td>
                                <td>{{ number_format($penalty['rate_percentage'], 2) }} <strong>%</strong></td>
                                <td>{{ number_format($penalty['rate_amount'], 2) }} <strong>{{ $penalty->currency}}</strong></td>
                                <td>{{ number_format($penalty['penalty_amount'], 2)}} <strong>{{ $penalty->currency}}</strong></td>
                            </tr>
                            @endforeach
                        @else
                            <tr>
