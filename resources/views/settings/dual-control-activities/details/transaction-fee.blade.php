        ...
        <div class="card-body">
            <div class="row m-2 pt-3">
                <div class="col-md-3 mb-3">
                    ...
                    <p class="my-1">{{ $result->action == \App\Models\DualControl::ADD ? $data->minimum_amount : $old_values->minimum_amount }}</p>
                </div>

                <div class="col-md-3 mb-3">
                    <span class="font-weight-bold text-uppercase">Maximum Amount</span>
                    <p class="my-1">{{ $result->action == \App\Models\DualControl::ADD ? $data->maximum_amount : $old_values->maximum_amount }}</p>
                </div>

                <div class="col-md-3 mb-3">
                    <span class="font-weight-bold text-uppercase">Fee</span>
                    <p class="my-1">{{ $result->action == \App\Models\DualControl::ADD ? $data->fee : $old_values->fee }}</p>
                </div>
