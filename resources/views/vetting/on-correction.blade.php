...
@section('title', 'On Correction Tax Returns Vetting')
                    ...
                    <div id="domestic-tax-payers" class="tab-pane fade active show p-2">
                        <div class="card p-2">
                            <livewire:vetting.vetting-approval-table
                                vettingStatus="{{ \App\Enum\VettingStatus::CORRECTION }}" />
                        </div>
                    </div>
                @endcan
                @can('tax-returns-vetting-view-domestic-taxpayers')
                    <div id="pemba" class="tab-pane fade show p-2">
                        <div class="card p-2">
                            <livewire:vetting.vetting-approval-table-pemba vettingStatus="{{ \App\Enum\VettingStatus::CORRECTION }}" />
                        </div>
                    </div>
                @endcan
                @can('tax-returns-vetting-view-lto-taxpayers')
                    <div id="large-tax-payers" class="tab-pane fade p-2">
                        <livewire:vetting.vetting-approval-table-lto
                            vettingStatus="{{ \App\Enum\VettingStatus::CORRECTION }}" />
                    </div>
                @endcan
                @can('tax-returns-vetting-view-non-tax-revenue-taxpayers')
