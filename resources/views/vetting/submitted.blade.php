        ...
        <nav class="nav nav-tabs mt-0border-top-0">
            ...
            <div class="tab-content px-2 pt-3 pb-2 border border-top-0">
                ...
                <div id="large-tax-payers" class="tab-pane fade p-2">
                    <livewire:vetting.vetting-approval-table-lto vettingStatus="{{ \App\Enum\VettingStatus::SUBMITTED }}" />
                </div>
                <div id="non-tax-revenues" class="tab-pane fade p-2">
                    <div class="card p-2">
                    <livewire:vetting.vetting-approval-table-ntl vettingStatus="{{ \App\Enum\VettingStatus::SUBMITTED }}" />
                    </div>
                </div>
            </div>
        </div>
