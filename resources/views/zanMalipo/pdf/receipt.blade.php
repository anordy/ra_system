...
<div class="top align-center">
    <img src="{{ public_path() }}/images/logo.png" width="100" alt="ZRA Logo">
...
<div class="center">
    <table width="100%">
        ...
        <tr>
            ...
            <td colspan="2" class="td-content">:
                @if ($bill->bill_payments->count() > 0)
                    {{ $bill->bill_payments()->latest()->first()->psp_receipt_number }}
                @endif
            </td>
        </tr>
        <tr>
    ...
    <table width="100%">
        ...
        <tr>
            <td>Paid On</td>
            <td colspan="3">:
                {{ $bill->payment->trx_time ? \Carbon\Carbon::make($bill->payment->trx_time)->format('d-M-Y H:i') : 'N/A' }}
            </td>
        </tr>
        <tr>
            <td>Issued By</td>
